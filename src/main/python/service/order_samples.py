...
class OrderSamples:
    ...
    @staticmethod
    def Discretionary(
        action: str, quantity: float, price: float, discretionaryAmount: float
    ):
    ...
    def RelativePeggedToPrimary(
        action: str, quantity: float, priceCap: float, offsetAmount: float
    ):
    ...
    def AuctionPeggedToStock(
        action: str, quantity: float, startingPrice: float, delta: float
    ):
    ...
    @staticmethod
    def LimitIfTouched(
        action: str, quantity: float, limitPrice: float, triggerPrice: float
    ):
    ...
    def PeggedToMidpoint(
        action: str, quantity: float, offset: float, limitPrice: float
    ):
    ...
    @staticmethod
    def TrailingStop(
        action: str, quantity: float, trailingPercent: float, trailStopPrice: float
    ):
    ...
    @staticmethod
    def ComboLimitOrder(
        action: str, quantity: float, limitPrice: float, nonGuaranteed: bool
    ):
    ...
    def LimitOrderForComboWithLegPrices(
        action: str, quantity: float, legPrices: list, nonGuaranteed: bool
    ):
    ...
    @staticmethod
    def Volatility(
        action: str, quantity: float, volatilityPercent: float, volatilityType: int
    ):
