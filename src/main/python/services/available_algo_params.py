...
class AvailableAlgoParams(Object):
    ...
    def FillScaleParams(
        ...
        # Profit Orders
        baseOrder.scaleProfitOffset = (
            scaleProfitOffset  # Create profit taking order Profit Offset
        )
    ...
    def FillBalanceImpactRiskParams(
        baseOrder: Order, maxPctVol: float, riskAversion: str, forceCompletion: bool
    ):
